...
private:
  ...
  void convert_view_to_view_template(double *current_view, const unsigned char *view_rgb, bool greyscale, int X_RANGE_MIN, int X_RANGE_MAX, int Y_RANGE_MIN, int Y_RANGE_MAX);
